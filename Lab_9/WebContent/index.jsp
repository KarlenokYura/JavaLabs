...
<body>
    ...
    <form action="Ccc" method="get">
        ...
        F1 <input type="radio" name="filter" value="F1" label="F1" title=""/><br/>
        F2 <input type="radio" name="filter" value="F2" label="F2" title=""/><br/>
        F3 <input type="radio" name="filter" value="F3" label="F3" title=""/><br/>
        Chain <input type="radio" name="filter" value="Chain" label="Chain" title=""/><br/>
